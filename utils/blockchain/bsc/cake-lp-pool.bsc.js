...
class BSCCakeLpPool extends BaseBSC {

    constructor(opts) {
        super(opts);
        this.contractAbi = require('../../../configs/bsc/cake-lp-pool.abi');
        this.contractAddr = opts.contractAddr;
    }

    async getTVLAndVolume(_price = 0) {
        try {
            ...
            let _tvl = parseFloatNumber(parseInt(_result[9]) / 1e18, 18);
            return {
                tvl: _tvl * _price,
                volume: 0
            };
